# data get
execute store result score $CP-X1 R.X run data get storage pk-utility: World-Spawn.Pos[0] 0.1
execute store result score $CP-X1 R.X run data get storage pk-utility: World-Spawn.Pos[2] 0.1
